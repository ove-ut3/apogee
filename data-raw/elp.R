...
devtools::use_data(elp, overwrite = TRUE)
...
devtools::use_data(elp_nature, overwrite = TRUE)
...
devtools::use_data(elp_periode, overwrite = TRUE)

#### ELP histo ####

elp_histo <- impexp::access_import("elp_histo", "data-raw/Tables_ref.accdb")

devtools::use_data(elp_histo, overwrite = TRUE)
