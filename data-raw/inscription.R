...
devtools::use_data(profil_etudiant, overwrite = TRUE)

#### Régime inscription ####

regime_inscription <- impexp::access_import("regime_inscription", "data-raw/Tables_ref.accdb")

devtools::use_data(regime_inscription, overwrite = TRUE)
...
devtools::use_data(bourse, overwrite = TRUE)
...
devtools::use_data(situation_sociale, overwrite = TRUE)
...
devtools::use_data(etablissement_type, overwrite = TRUE)
